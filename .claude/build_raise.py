...
$10M seed (IKON inside) → commercial validation → institutional credit → $25M Series A.
...
<header class="pl-hero" id="top">
  <div class="pl-hero-inner">
    ...
    <h1>{money(SEED)} to prove it. Credit to finance it. $25M to scale it.</h1>
    <p class="pl-sub">VYB is building the financial operating system for live commerce — the financial workflows of artists, management, promoters, venues, vendors and event operators on one ledger. The financing strategy is a deliberate progression: a <em>{money(SEED)} seed</em> funds production infrastructure and three strategic commercial deployments that turn a forecast into proof; an <em>institutional credit facility</em> finances the transaction volume those deployments create; and a <em>$25M Series A</em> scales a financial network that already exists. Equity builds VYB. Credit finances what runs through it.</p>
    ...
    <div class="kpis kpis-hero">
      {kpi(money(SEED), 'seed · target raise', 'Build production infrastructure, deploy commercially, generate TPV and recurring revenue. IKON commits inside the round.')}
      {kpi(money(PRE) + ' → ' + money(POST), 'pre → post-money · target', f'{pct(OWN)} to new investors, including the strategic allocation, before other capitalization considerations.')}
      {kpi('$25M → $100M+', 'credit facility · accordion', 'Finances the volume the deployments create. Non-dilutive.')}
      {kpi('$25M', 'Series A · strategic target', 'At a $125M+ pre-money, after the facility and three deployments.')}
    </div>
  </div>
</header>
...
<div class="pl-shell">
  ...
  <main class="pl-main">
    ...
    <section class="pl-sec" id="thesis">
      ...
      <h2 class="pl-h">Seed → commercial validation → institutional credit → Series A.</h2>
      <p class="pl-lede">The seed is not runway. It is the capital that builds production infrastructure, executes strategic commercial deployments, generates meaningful transaction volume, establishes recurring revenue, and proves VYB can operate across multiple layers of the live-entertainment ecosystem. It is raised once IKON is a signed design partner with a written pathway to production, and it is sized to reach the credit facility without a second equity event.</p>
      <div class="fc-chain" data-io="">
        ...
        <div class="cn"><div class="k">Institutional credit</div><div class="v">$25M → $100M+</div></div><div class="ar">↓</div>
        <div class="cn hi"><div class="k">Series A</div><div class="v">$25M at $125M+</div></div>
      </div>
    </section>
    ...
    <section class="pl-sec" id="seed">
      ...
      <div class="kpis" data-io="">
        {kpi(money(SEED), 'target raise', '$8M institutional lead and others · $2M IKON')}
        {kpi(money(PRE), 'pre-money · illustrative')}
        {kpi(money(POST), 'post-money · target', '$45M–$50M post-money economics')}
        {kpi(pct(OWN), 'issued to new investors', 'before other capitalization considerations')}
      </div>
      <div class="fc-two" data-io="">
        <div>{kv([('Structure', f'A priced round is the base case: {money(PRE)} pre-money + {money(SEED)} new capital = {money(POST)} post-money, with an option pool sized to the hiring plan.'), ('Strategic participation', 'IKON commits $2M inside the round at the round price — design partner and anchor customer first, investor on the same terms as the lead. No separate strategic equity, no bespoke governance.'), ('Alternative', 'A post-money SAFE, if strategically advantageous — counsel to evaluate dilution, cap-table implications, investor rights and future financing consequences before the instrument is chosen.'), ('Objective', 'Preserve founder ownership, reach the credit facility on this round alone, and enter the Series A with an institutionally attractive capitalization.')])}</div>
    ...
    <section class="pl-sec" id="seriesa">
      <div class="pl-sec-num">09 — THE SERIES A</div>
      <h2 class="pl-h">Not a $100M Series A. A $25M one, at a $125M+ pre-money, after the facility.</h2>
      <p class="pl-lede">Raised after genuine product-market fit and repeatability, and priced on the metrics VYB has generated by then: three deployments, an institutional credit facility in place, and transaction volume that the facility, not equity, is financing. The round is sized to build the company. It does not fund volume, because the facility already does. A larger growth round is a choice at $1B+, not a milestone on the way there.</p>
      ...
      <div class="rs-grid" data-io="">
        <div><b>$100M–$250M+</b><span>annualized TPV</span></div>
        <div><b>$1M–$5M+</b><span>annualized revenue</span></div>
        <div><b>In place</b><span>institutional credit facility, drawing against eligible receivables</span></div>
    ...
    <section class="pl-sec" id="deploy">
      ...
      <h2 class="pl-h">A $25M round accelerates a proven network. It does not extend runway, and it does not fund volume.</h2>
      ...
      <div class="fc-table-wrap" data-io="">{table(SERIES_A, 'Series A deployment · $25M')}</div>
    </section>
    ...
    <section class="pl-sec" id="roadmap">
      ...
      <div class="fc-chain" data-io="">
        ...
        <div class="cn wide"><div class="k">Receivables · production · structured facilities</div><div class="v">finance $500M–$1B+ of underlying commerce</div></div><div class="ar">↓</div>
        <div class="cn wide"><div class="k">Optional $100M growth round at $1B+</div><div class="v">only to build the company, never to fund volume</div></div>
      </div>
    </section>
    ...
    <section class="pl-sec" id="captable">
      ...
      <p class="pl-note">Objective: reach the credit facility on the seed alone, and enter the $25M Series A with a clean, institutionally attractive capitalization structure and founder ownership intact.</p>
    </section>
    ...
    <section class="pl-sec" id="philosophy">
      ...
      <div class="rs-phil" data-io="">
        ...
        <div><b>$25M</b><span>Scale</span></div>
...
TITLE = "VYB — Raise"
DESC = "VYB's capital strategy: a $10M seed that funds production infrastructure and three strategic commercial deployments, an institutional credit facility that finances the volume, and a $25M Series A that scales a network that already exists."
page = f"""<!DOCTYPE html>
